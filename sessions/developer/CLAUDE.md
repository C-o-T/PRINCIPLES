...
2. 이 파일 읽기
3. `sessions/developer/STATE.md` 읽기 (없으면 최초 투입 — 빈 STATE.md 생성 후 계속)
4. `sessions/_shared/PROJECT_CONTEXT.md` 읽기 (기술 스택, 패턴 확인)
...
결과 반환 전 `sessions/developer/STATE.md`를 갱신한다.
